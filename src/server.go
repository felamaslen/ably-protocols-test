...
const PORT_STATELESS = 8080

const CONNECTION_DEADLINE = 30 * time.Second

func generateInitialNumber() int64 {
  return int64(math.Max(1, rand.Float64() * 0xff))
}
